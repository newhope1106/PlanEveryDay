...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '</div>',
            '</div>',
            '<div class="calendar-label"><p>Hello vivo</p><i></i></div>'
        ],
    ...
    Calendar.prototype = {
        ...
        trigger: function() {
            ...
            _this.$trigger.click(function() {
                var post = _this.$trigger.offset();
                var offs = _this.options.offset;

                $this.addClass('calendar-modal').css({
                    left: (post.left + offs[0]) + 'px',
                    top: (post.top + offs[1] -  _this.$trigger.outerHeight() + 25) + 'px',
